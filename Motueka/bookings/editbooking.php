            ...
            <div class="row">
                <div class="mb-3 mt-3">
                    <p>
                        ...
                        <input style="margin-left: 2%;" class="form-control-sm" type="tel" id="MobileNumber" name="MobileNumber" value="<?php echo '0' . $row['contactNum']; ?>" required pattern="([0-9]{3}[0-9]{3}[0-9]{4}|[0-9]{3}[0-9]{4}[0-9]{4})" />
                    </p>
                </div>
            </div>
            <div class="row">
